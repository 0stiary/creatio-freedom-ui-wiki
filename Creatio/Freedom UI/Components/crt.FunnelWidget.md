...
Angular-селектор: `<crt-funnel-widget>`  
...
**crt.FunnelWidget** → *BaseWidget* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.FunnelWidget** (власні) | `config`, `funnelTypeList`, `isDesignTime` | — |  |
