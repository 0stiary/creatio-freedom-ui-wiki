...
**crt.TabPanelHeaderItem** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TabPanelHeaderItem** (власні) | `caption`, `hint`, `icon`, `iconPosition`, `iconSource`, `selected`, `selectedTitleColor`, `styleType`, `titleColor` | `selectedChange` |  |
