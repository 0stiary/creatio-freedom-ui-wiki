---
type: crt.TableEmailCell
selector: crt-data-table-email-cell
group: "Комірки гріда"
...
Angular-селектор: `<crt-data-table-email-cell>`  
Група: **Комірки гріда**  
reuseStrategy: `Reuse`  
...
**crt.TableEmailCell** → *BaseTableCell*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TableEmailCell** (власні) | `disableLink` | — |  |
