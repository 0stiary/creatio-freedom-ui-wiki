...
selector: crt-full-pipeline-widget
...
Angular-селектор: `<crt-full-pipeline-widget>`  
...
**crt.FullPipelineWidget** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.FullPipelineWidget** (власні) | `config`, `toolbarMenuItems` | — |  |
