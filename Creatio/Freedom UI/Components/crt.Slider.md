...
| `color` |  | `"primary"` | 1 | (успадковано від базового класу) |
...
| `label` | `"Slider"` | `<binding>` | 1 | (успадковано від базового класу) |
| `maxValue` |  | `4` | 1 | (успадковано від базового класу) |
| `minValue` |  | `1` | 1 | (успадковано від базового класу) |
| `paddingLineMode` |  |  |  | (успадковано від базового класу) |
| `readonly` |  | `false` | 1 | (успадковано від базового класу) |
| `step` |  | `1` | 1 | (успадковано від базового класу) |
...
| `layoutConfig.colSpan` | 1 | `1` |  |
| `layoutConfig.column` | 1 | `2` |  |
| `layoutConfig.row` | 1 | `2` |  |
