...
| `readonly` |  | `true`, `false` | (успадковано від базового класу) |
...
**crt.AccountCompactProfile** → *BaseCompactProfile* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.AccountCompactProfile** (власні) | `accountName`, `accountNameValidationInfo`, `alternativeName`, `city`, `country`, `timeZone` | — |  |
