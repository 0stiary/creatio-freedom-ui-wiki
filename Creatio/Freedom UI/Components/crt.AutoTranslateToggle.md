...
selector: crt-auto-translate-toggle
...
Angular-селектор: `<crt-auto-translate-toggle>`  
...
**crt.AutoTranslateToggle** → [[crt.TranslateToggle]] → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.AutoTranslateToggle** (власні) | — | — |  |
| [[crt.TranslateToggle]] | — | `translationError$`, `translationReady` |  |
