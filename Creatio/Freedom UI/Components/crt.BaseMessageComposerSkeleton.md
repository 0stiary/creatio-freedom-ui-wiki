...
selector: crt-base-message-composer-skeleton
...
Angular-селектор: `<crt-base-message-composer-skeleton>`  
...
**crt.BaseMessageComposerSkeleton** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.BaseMessageComposerSkeleton** (власні) | — | — |  |
