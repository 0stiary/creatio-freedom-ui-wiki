---
type: crt.TimelineLabel
selector: crt-timeline-label
...
Angular-селектор: `<crt-timeline-label>`  
...
**crt.TimelineLabel** → [[crt.BaseTimelineLabel]]

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TimelineLabel** (власні) | `dataValueType` | — |  |
