---
type: crt.TimelineEmailLabel
selector: crt-timeline-email-label
...
Angular-селектор: `<crt-timeline-email-label>`  
...
**crt.TimelineEmailLabel** → [[crt.BaseTimelineLabel]]

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TimelineEmailLabel** (власні) | — | — |  |
| [[crt.BaseTimelineLabel]] | `caption`, `value` | — |  |
