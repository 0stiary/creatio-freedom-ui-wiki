...
selector: crt-data-table-rich-text-editor-cell
group: "Комірки гріда"
...
Angular-селектор: `<crt-data-table-rich-text-editor-cell>`  
Група: **Комірки гріда**  
reuseStrategy: `Reuse`  
...
**crt.TableRichTextEditorCell** → *BaseTableCell*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TableRichTextEditorCell** (власні) | — | — |  |
