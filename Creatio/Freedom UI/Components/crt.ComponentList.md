...
Angular-селектор: `<ts-component-list>`  
Група: **Списки і дані**  
reuseStrategy: `Reuse`  
...
**crt.ComponentList** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.ComponentList** (власні) | `itemViewConfig`, `viewModels` | — |  |
