...
Angular-селектор: `<crt-icon-radio-button>`  
...
**crt.IconRadioButton** → *(базовий клас не розв'язано — його модуль відсутній у збережених чанках Shell; за архітектурою це BaseViewElement)*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.IconRadioButton** (власні) | `control`, `direction`, `disabled`, `disabledStateTooltip`, `items`, `label`, `radioGroupAriaLabel`, `value` | — |  |
