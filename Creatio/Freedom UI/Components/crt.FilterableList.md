...
Angular-селектор: `<ts-filterable-list>`  
Група: **Списки і дані**  
reuseStrategy: `Reuse`  
...
**crt.FilterableList** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.FilterableList** (власні) | `items` | `favoriteStateChanged`, `itemSelected` |  |
