...
Angular-селектор: `<crt-operator-state>`  
...
**crt.OperatorState** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.OperatorState** (власні) | `useGlassmorphism` | — |  |
