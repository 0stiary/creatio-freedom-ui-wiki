...
| `label` | `""` | `"Email"` | (успадковано від базового класу) |
...
**crt.EmailInput** → [[crt.Input]] → *BaseInputControl* → *BaseFormControl* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.EmailInput** (власні) | `isFormatValidated` | — |  |
