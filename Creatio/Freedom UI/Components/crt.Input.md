...
| `multiline` | `false` | `false`, `true` | textarea |
| `autocomplete` | `"none"` |  | (успадковано від базового класу) |
| `autofocus` | `false` |  | (успадковано від базового класу) |
| `readonly` | `false` | `false`, `true` | тільки читання (не плутати з `disabled`) |
...
| `control` |  | `<binding>` | `"$PDS_Column"` |
| `disabled` |  |  | (успадковано від базового класу) |
| `label` | `""` | `<binding>` | (успадковано від базового класу) |
| `labelPosition` |  | `"auto"`, `"above"`, `"hidden"`, `"left"` | `auto` / `above` / `left` |
| `placeholder` |  | `""`, `<binding>`, `"#ResourceString(JobTitle_placeholder)#"`, `"#ResourceString(Dear_placeholder)#"` | (успадковано від базового класу) |
...
| `layoutConfig.row` | `1`, `2`, `5`, `3`, `6`, `4` |  |
| `layoutConfig.rowSpan` | `1`, `3`, `4`, `2` |  |
...
**crt.Input** → *BaseInputControl* → *BaseFormControl* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.Input** (власні) | `displayTools`, `inputType`, `mask`, `multiline` | — |  |
| *BaseInputControl* | `autocomplete`, `autofocus`, `id`, `readonly`, `value` | — | `id, value, readonly, autofocus, autocomplete` (+ `ngDoCheck`) |
...
Нащадки (компоненти, що наслідують цей): [[crt.EmailInput]], [[crt.FileInput]], [[crt.ImageInput]], [[crt.PasswordInput]], [[crt.PhoneInput]], [[crt.WebInput]]
