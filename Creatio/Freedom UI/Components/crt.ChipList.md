...
Angular-селектор: `<crt-chip-list>`  
...
**crt.ChipList** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.ChipList** (власні) | `ariaLabel`, `items`, `readonly`, `wrap` | `itemClick`, `itemRemove` |  |
