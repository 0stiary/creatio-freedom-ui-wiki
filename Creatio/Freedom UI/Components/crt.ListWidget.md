...
| `widgetConfig` | `{}` |  |  |
| `widgetToolbarItems` | `[]` |  |  |
| `activeRow` |  | `<binding>` | (успадковано від базового класу) |
...
| `items` |  | `<binding>` | (успадковано від базового класу) |
| `maxHeight` |  |  | (успадковано від базового класу) |
| `primaryColumnName` |  | `"ListWidget_wgiaud9DS_Id"` | (успадковано від базового класу) |
| `rowToolbarItems` | `[]` |  | (успадковано від базового класу) |
| `selectedRows` |  |  | (успадковано від базового класу) |
| `selectionState` |  | `<binding>` | (успадковано від базового класу) |
| `sorting` |  |  | (успадковано від базового класу) |
| `stretch` |  |  | (успадковано від базового класу) |
| `title` |  | `<binding>` | (успадковано від базового класу) |
...
|---|---|---|
| `_selectionOptions.attribute` | `"ListWidget_wgiaud9_SelectionState"` |  |
| `columns[].caption` | `<binding>` |  |
| `columns[].code` | `"ListWidget_wgiaud9DS_CreatedOn"` |  |
| `columns[].dataValueType` | `7` |  |
| `columns[].id` | `"3b745f55-618e-9b83-debd-8d20e46ffd3a"` |  |
| `features.columns` |  |  |
| `features.columns.dragAndDrop` | `false` |  |
| `features.columns.resizing` | `true` |  |
| `features.columns.sorting` | `true` |  |
| `features.editable` | `false` |  |
| `features.rows` |  |  |
| `features.rows.numeration` | `true` |  |
| `features.rows.selection` | `false` |  |
| `features.header` |  |  |
| `features.header.visible` | `true` |  |
| `features.rows.selection.enable` | `true` |  |
| `features.rows.selection.multiple` | `false` |  |
| `features.columns.adding` | `false` |  |
| `features.columns.toolbar` | `false` |  |
| `features.rows.hierarchical` | `false` |  |
| `features.rows.toolbar` | `false` |  |
| `layoutConfig.colSpan` | `12` |  |
| `layoutConfig.column` | `1` |  |
| `layoutConfig.row` | `12` |  |
| `layoutConfig.rowSpan` | `16` |  |
| `widgetConfig.layout` |  |  |
| `widgetConfig.layout.color` | `"dark-blue"` |  |
| `widgetConfig.theme` | `"without-fill"` |  |
