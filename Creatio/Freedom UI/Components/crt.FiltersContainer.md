...
selector: crt-filters-container
group: "Фільтри"
...
Angular-селектор: `<crt-filters-container>`  
Група: **Фільтри**  
...
**crt.FiltersContainer** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.FiltersContainer** (власні) | `entitySchemaName`, `filterData` | `filterDataChange` |  |
