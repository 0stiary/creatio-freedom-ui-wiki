---
type: crt.ObjectExplorer
selector: crt-object-explorer
group: "Списки і дані"
...
Angular-селектор: `<crt-object-explorer>`  
Група: **Списки і дані**  
reuseStrategy: `Reuse`  
...
**crt.ObjectExplorer** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.ObjectExplorer** (власні) | — | — |  |
