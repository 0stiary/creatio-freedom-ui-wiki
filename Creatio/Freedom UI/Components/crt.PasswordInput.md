...
Angular-селектор: `<crt-password-input>`  
Група: **Поля вводу**  
reuseStrategy: `Reuse`  
...
```json
{type:"crt.PasswordInput",formControlConfig:{relatesTo:"control"},reuseStrategy:b.B.Reuse}
```
...
**crt.PasswordInput** → [[crt.Input]] → *BaseInputControl* → *BaseFormControl* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.PasswordInput** (власні) | `validations` | — |  |
