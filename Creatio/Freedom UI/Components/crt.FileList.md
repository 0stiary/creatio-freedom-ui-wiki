...
**crt.FileList** → [[crt.DataGrid]] → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.FileList** (власні) | `droppable`, `features`, `fileGroups`, `galleryItemConfig`, `items`, `masterRecordColumnValue`, `recordColumnName`, `tag`, `viewType` | `fileDropped`, `uploadClicked` |  |
| [[crt.DataGrid]] | `activeRow`, `bulkActions`, `columns`, `editingCells`, `fitContent`, `header`, `headerToolbarItems`, `hierarchicalColumnName`, `maxHeight`, `primaryColumnName`, `rowToolbarItems`, `selectedRows`, `selectionState`, `sorting`, `stretch`, `title`, `totalItemsCount` | `activeRowChange`, `cancelItemsChanges`, `columnsChange`, `createItem`, `deleteItem`, `paginationChange`, `rowDoubleClick`, `saveItemsChanges`, `selectedRowsChange`, `selectionStateChange`, `sortingChange` |  |
