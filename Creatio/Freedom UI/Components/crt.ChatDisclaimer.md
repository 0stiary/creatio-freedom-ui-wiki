...
Angular-селектор: `<crt-chat-disclaimer>`  
...
**crt.ChatDisclaimer** → *BaseContainer* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.ChatDisclaimer** (власні) | `caption`, `consentCode` | `acceptClicked` |  |
