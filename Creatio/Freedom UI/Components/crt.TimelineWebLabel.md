---
type: crt.TimelineWebLabel
selector: crt-timeline-web-label
...
Angular-селектор: `<crt-timeline-web-label>`  
...
**crt.TimelineWebLabel** → [[crt.BaseTimelineLabel]]

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TimelineWebLabel** (власні) | — | — |  |
