...
**crt.PhoneInput** → [[crt.Input]] → *BaseInputControl* → *BaseFormControl* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.PhoneInput** (власні) | `alwaysShowFlags`, `countrySelectionConfig`, `displayAsPhone`, `isGridMode`, `isViewCellMode`, `phoneAsLink` | — |  |
