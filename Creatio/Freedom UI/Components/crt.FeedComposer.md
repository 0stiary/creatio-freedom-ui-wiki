...
|---|---|---|
| `data.caption` | `"Feed"` |  |
| `data.icon` | `"feed-composer-icon"` |  |
| `data.schemaType` | `"Feed"` |  |
| `data.sortedByColumn` | `"CreatedOn"` |  |
| `data.typeName` | `"crt.FeedComposer"` |  |
| `data.uId` | `"6d006667-3496-4e2d-adc0-3a42648dd97b"` |  |
