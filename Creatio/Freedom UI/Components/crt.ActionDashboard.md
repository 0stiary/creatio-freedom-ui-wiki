...
**crt.ActionDashboard** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.ActionDashboard** (власні) | `allowedActions`, `dataSourceName`, `entitySchemaName`, `fitContent`, `primaryColumnValue`, `primaryDisplayColumnValue`, `title` | — |  |
