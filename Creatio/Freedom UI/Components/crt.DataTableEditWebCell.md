...
selector: crt-data-table-edit-web-cell
group: "Комірки гріда"
tags: [creatio, freedom-ui, view-element]
generated: 2026-09-16
---
# crt.DataTableEditWebCell

Angular-селектор: `<crt-data-table-edit-web-cell>`  
Група: **Комірки гріда**  
reuseStrategy: `Reuse`  
...
```json
{type:"crt.DataTableEditWebCell",formControlConfig:{relatesTo:"control"},reuseStrategy:w.B.Reuse}
```
