...
selector: crt-data-table-dcm-stage-cell
group: "Комірки гріда"
...
Angular-селектор: `<crt-data-table-dcm-stage-cell>`  
Група: **Комірки гріда**  
reuseStrategy: `Reuse`  
...
**crt.TableDcmStageCell** → *BaseTableCell*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TableDcmStageCell** (власні) | `dcmStages`, `value` | — |  |
| *BaseTableCell* | `column`, `record` | — | комірка гріда: `value, record, column`; `getTitle()` |
