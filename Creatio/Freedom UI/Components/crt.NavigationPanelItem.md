...
selector: crt-navigation-panel-item
...
Angular-селектор: `<crt-navigation-panel-item>`  
...
**crt.NavigationPanelItem** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.NavigationPanelItem** (власні) | `isCollapsed`, `openItemAsLink`, `panelItem`, `usePanelIconBackground` | `selected` |  |
