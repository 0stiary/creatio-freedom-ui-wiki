...
selector: crt-message-editor-reply
...
Angular-селектор: `<crt-message-editor-reply>`  
...
**crt.MessageEditorReply** → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.MessageEditorReply** (власні) | — | — |  |
