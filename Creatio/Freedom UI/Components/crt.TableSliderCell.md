...
selector: crt-data-table-slider-cell
group: "Комірки гріда"
...
Angular-селектор: `<crt-data-table-slider-cell>`  
Група: **Комірки гріда**  
reuseStrategy: `Reuse`  
...
**crt.TableSliderCell** → *BaseTableCell*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.TableSliderCell** (власні) | `color`, `percentage` | — |  |
