...
Angular-селектор: `<crt-encrypted-input>`  
Група: **Поля вводу**  
reuseStrategy: `Reuse`  
...
```js
{toolbarConfig:{requiredFeatures:{EnableSecureTextMasking:true},position:60,icon:t(83482),defaultPropertyValues:{label:"",labelPosition:"auto"},defaultLocalizableStrings:{label:"Components.EncryptedInput.Caption"}},propertiesPanelComponentTypeName:"crt.EncryptedInputPropertiesPanel",typeCaption:"Components.EncryptedInput.Caption",viewElementGroupType:f.J.Inputs,dataValueTypes:[v.r.SECURE_TEXT]}
```
...
```json
{type:"crt.EncryptedInput",formControlConfig:{relatesTo:"control"},reuseStrategy:l.B.Reuse}
```
...
**crt.EncryptedInput** → *BaseInputControl* → *BaseFormControl* → *BaseViewElement* → *BaseComponent*

| Рівень | Оголошує inputs | Оголошує outputs | Роль |
|---|---|---|---|
| **crt.EncryptedInput** (власні) | `state`, `unmaskingDisabled` | `toggleMaskValue`, `valueChange` |  |
